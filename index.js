...
// ตรวจสถานะทุกชั่วโมง ตลอด 24 ชั่วโมง (batch ทุกเลขในคำขอเดียว)
//
...
//
// เปิดตลอดไม่ได้แปลว่าเปลืองโควต้า LINE ขึ้น จำนวนขั้นที่แจ้งเท่าเดิม แค่ตรงเวลาขึ้น
//
// ความถี่ต้องคิดจากโควต้า "API ไปรษณีย์" ซึ่งนับเป็นเลขพัสดุ ไม่ใช่จำนวนคำขอ
// บัญชีละ 1,000 เลข/วัน — รวมทุกเลขไว้ในคำขอเดียวก็ยังนับทุกเลขอยู่ดี
// พอเกินโควต้า ไปรษณีย์ตอบ 200 พร้อม body ว่า over quota แล้วทุกใบหยุดอัปเดต
// รวมถึงปุ่ม "พัสดุของฉัน" ที่ลูกค้ากดเช็คเองด้วย
//
// เดิมทุก 10 นาที = กล่องละ 144 ครั้ง/วัน แค่ 7 กล่องก็เต็ม
// วันที่ 15 ก.ย. 69 หลังส่งของล็อตใหญ่ โควต้าหมดตั้งแต่เช้า ลูกค้ากดเช็คเองก็ไม่ได้
//
// ทุกชั่วโมง = กล่องละ 24 ครั้ง/วัน → token เดียวรับได้ ~40 กล่อง สองตัว ~80 (ดู thaipost.js)
// ที่เสียคือถ้านำจ่ายเสร็จภายในชั่วโมงเดียว ลูกค้าจะได้แค่ "นำจ่ายสำเร็จ"
